    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand_image', models.ImageField(blank=True, null=True, upload_to='uploads/')),
            ],
        ),
        migrations.CreateModel(
            name='CancelOrder',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('media_type', models.CharField(choices=[('image', 'Image'), ('video', 'Video')], max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_media', models.ManyToManyField(blank=True, to='ecommerce_app.productmedia')),
                ('subcategories_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecommerce_app.subcategories')),
